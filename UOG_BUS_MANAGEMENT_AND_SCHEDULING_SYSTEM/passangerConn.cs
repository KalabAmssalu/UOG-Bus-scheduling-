...
namespace UOG_BUS_MANAGEMENT_AND_SCHEDULING_SYSTEM
{
    class passangerConn
    {
        ...
        {
            MySqlCommand command = new MySqlCommand("INSERT INTO `passenger`(`PassangerId`, `FirstName`, `LastName`, `Gender`, `Phone`, `SpecialCare`, `Address_City`,`Address_Kebele`, `work_Area`, `Blocked`, `Image`) VALUES(@Pid,@fn, @ln, @Gd, @Pno, @Sc, @Cit,@keb,@WA,@BL, @img)", connect.getconnection);
